...
import { ArrowLeft, Save, X, Image, Tag, DollarSign, List, CheckCircle, Plus, Trash2 } from 'lucide-react';
...
export default function NovoProduto() {
  ...
  const [variacoes, setVariacoes] = useState([
    { cor: '', imagem_url: '', ativo: true, ordem: 0 }
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('❌ Erro ao criar produto: ' + (error.response?.data?.erro || 'Tente novamente'), 'error');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="border-t border-gray-200 pt-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-500">Adicione cores ou variações do produto</p>
              </div>
              <button
                type="button"
                onClick={addVariacao}
